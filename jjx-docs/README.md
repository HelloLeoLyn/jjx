...
> 🚦 **想知道"这套系统现在能不能上线、还差什么"？** 看 `guides/production-readiness-plan-20260914.md` —— **生产前置核查清单**（上生产前必须过的 7 组 26 项：🔴硬前置 / 🟡待拍板）。当前进度：✅2 / 🟨8（已查清、待动作）/ ⏸2（用户定暂缓）/ ⏳1（已开任务）/ ⬜14。**26 项没核查完，不安排上线。**

## 目录（章 → 篇）

### 第 1 章 上生产（现在还没上线，这一章回答"还差什么"）
- `guides/production-readiness-plan-20260914.md` —— 生产前置核查清单（7 组 26 项）🚦 进度：✅2 / 🟨8（已查清待动作）/ ⏸2（暂缓）/ ⏳1（已开任务）/ ⬜14
...
| **我要准备上生产 / 想确认能不能上线** | 第 1 章《生产前置核查清单》（26 项）→ 第 2 章《脚本命令手册》（迁移/备份怎么跑） |
