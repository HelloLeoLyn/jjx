-- 备份人: hermes-agent
-- 原因: 登记 ops.schema.version（78）前的 sys_config guard 备份
-- 任务码: 无
...
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统配置表';
...
-- Dump completed on 2026-09-10 15:33:00
