...
) ENGINE=InnoDB AUTO_INCREMENT=1736 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='统一任务表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_task`
--
-- WHERE:  task_code='dev-20260912-006'

LOCK TABLES `sys_task` WRITE;
/*!40000 ALTER TABLE `sys_task` DISABLE KEYS */;
INSERT INTO `sys_task` VALUES (1735,'dev-20260912-006','DEV','engineering','按项目隔离 PaddleOCR 启动脚本与文档',NULL,NULL,NULL,NULL,NULL,NULL,0,'P2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Codex','2026-09-12 14:56:38','Codex','2026-09-12 14:56:38',NULL,NULL);
...
-- Dump completed on 2026-09-12 15:25:25
