...
) ENGINE=InnoDB AUTO_INCREMENT=1730 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='统一任务表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_task`
--
-- WHERE:  task_code='dev-20260912-001'

LOCK TABLES `sys_task` WRITE;
/*!40000 ALTER TABLE `sys_task` DISABLE KEYS */;
INSERT INTO `sys_task` VALUES (1728,'dev-20260912-001','DEV','sales','样品订单独立表与产品一对一拆分','实施中：已完成sales_sample_order建表、样品字段迁移删除、后端基础读写切换与编译验证；样品服务全链路切换、多产品报价拆单及前端仍需完成。提交 ae0975db。',NULL,NULL,NULL,NULL,NULL,1,'P1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Codex','2026-09-12 10:54:29','Codex','2026-09-12 11:26:32',NULL,NULL);
...
-- Dump completed on 2026-09-12 11:31:08
