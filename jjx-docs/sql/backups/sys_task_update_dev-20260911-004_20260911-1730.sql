-- JJX guard backup: before updating sys_task status for dev-20260911-004
-- reason: mark implementation as pending review after local OCR integration
-- operator: Codex
...
) ENGINE=InnoDB AUTO_INCREMENT=1723 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='统一任务表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_task`
--
-- WHERE:  task_code='dev-20260911-004'

LOCK TABLES `sys_task` WRITE;
/*!40000 ALTER TABLE `sys_task` DISABLE KEYS */;
INSERT INTO `sys_task` VALUES (1719,'dev-20260911-004','DEV','dev','工程管理历史档案智能录入','上传历史产品作业规范原图，识别产品名称/编号及材料表，创建草稿产品和BOM；识别面板/上线/下线工序图标并映射标准工序，创建草稿工艺路线；保存确认后的图标样本用于后续识别与系统延用。',NULL,NULL,NULL,NULL,NULL,0,'P2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Codex','2026-09-11 16:12:30',NULL,'2026-09-11 16:12:30',NULL,NULL);
...
-- Dump completed on 2026-09-11 17:27:28
