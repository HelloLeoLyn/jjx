-- 备份人: 大黄(OpenClaw)
-- 原因: 清理 IQC 旁路流水（类型 IQC_QUARANTINE/IQC_<ACTION>，未走 applyDelta、无批次行、inventory_item_id NULL）——非法写入，用户 2026-09-24 16:05 授权
-- 时间: 2026-09-24 16:06:34
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='库存流水表';
...
INSERT INTO `inventory_transaction` VALUES (1,NULL,1585,'RM001585','DG68 样品 (新亚洲)',2,NULL,'IQC_QUARANTINE','INBOUND_IQC',1,'IN260924001',NULL,NULL,'IN260924001-1',5,5.0000,0.0000,5.0000,5.0000,25.00,'2026-09-24 15:40:24',1,'系统管理员','IQC 不合格品隔离','admin','2026-09-24 15:40:24','admin','2026-09-24 15:40:24'),(2,NULL,1585,'RM001585','DG68 样品 (新亚洲)',2,NULL,'IQC_SCRAP','INBOUND_IQC',1,NULL,NULL,NULL,'IN260924001-1',5,1.0000,5.0000,4.0000,NULL,NULL,'2026-09-24 16:00:17',1,'系统管理员',NULL,'admin','2026-09-24 16:00:17','admin','2026-09-24 16:00:17');
...
-- Dump completed on 2026-09-24 16:06:34
