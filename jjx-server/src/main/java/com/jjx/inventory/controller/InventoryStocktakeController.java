...
public class InventoryStocktakeController {
    ...
    @Log(module = "盘点管理", businessType = BusinessType.INSERT, bizType = "'stocktake'", bizId = "#result.data", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).DRAFT.getLabel()")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).PROCESSING.getLabel()")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).CONFIRMED.getLabel()")
    @SaCheckPermission("inventory:stocktake:edit")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).PROCESSED.getLabel()")
    @SaCheckPermission("inventory:stocktake:edit")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).CLOSED.getLabel()")
    @SaCheckPermission("inventory:stocktake:edit")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).PENDING.getLabel()")
    @SaCheckPermission("inventory:stocktake:edit")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.APPROVE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).APPROVED.getLabel()")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).getByValue(#status)?.label")
    @SaCheckPermission("inventory:stocktake:edit")
