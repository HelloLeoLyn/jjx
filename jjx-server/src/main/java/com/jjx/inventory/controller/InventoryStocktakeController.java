...
public class InventoryStocktakeController {
    ...
    @Log(module = "盘点管理", businessType = BusinessType.INSERT, bizType = "'stocktake'", bizId = "#result.data", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).DRAFT.getLabel()", action = LogActions.STOCKTAKE_CREATE)
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).PROCESSING.getLabel()", action = LogActions.STOCKTAKE_START)
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).PROCESSING.getLabel()", action = LogActions.STOCKTAKE_INPUT)
    @SaCheckPermission("inventory:stocktake:edit")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).CONFIRMED.getLabel()", action = LogActions.STOCKTAKE_CONFIRM)
    @SaCheckPermission("inventory:stocktake:edit")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).PROCESSED.getLabel()", action = LogActions.STOCKTAKE_PROCESS_DIFF)
    @SaCheckPermission("inventory:stocktake:edit")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).CLOSED.getLabel()", action = LogActions.STOCKTAKE_CLOSE)
    @SaCheckPermission("inventory:stocktake:edit")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).PENDING.getLabel()", action = LogActions.STOCKTAKE_SUBMIT)
    @SaCheckPermission("inventory:stocktake:edit")
    ...
    @Log(module = "盘点管理", businessType = BusinessType.APPROVE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).APPROVED.getLabel()", action = LogActions.STOCKTAKE_APPROVE)
    ...
    @Log(module = "盘点管理", businessType = BusinessType.UPDATE, bizType = "'stocktake'", bizId = "#stocktakeId", bizStatus = "T(com.jjx.inventory.enums.InventoryOrderStatusEnum).getByValue(#status)?.label", action = LogActions.STOCKTAKE_UPDATE_STATUS)
    @SaCheckPermission("inventory:stocktake:edit")
