...
public interface ProductionTaskService {
    ...
    /** Validate that a supplemental report still has a confirmed, NCR-backed material issue source. */
    void validateSupplementTaskSource(Long workOrderId, ProductionTask task);
